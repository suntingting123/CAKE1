...
<script type="text/javascript" src="/cake/WebContent/jquery.min.js"></script>
<script>  
  
    window.onload = function() {
        document.getElementById("ajaxemail").onblur = function() {  
            if(this.value=="")  
                {  
                    alert("请输入用户名!");  
                    this.focus();  
            ...
            //3.建立与服务器的连接  
            xhr.open("POST", "${ctx }/user/findajax" + "?time=" + new Date().getTime());  
            xhr.setRequestHeader("Content-Type","application/x-www-form-urlencoded");  
            //4.向服务器发出请求  
            xhr.send("email="+this.value);  
			...
			<div class="register">
				<form action="/cake/user/regist"> 
					<div class="register-top-grid">
						...
						<input type="text" id="ajaxemail" name="email" /><span id="msg"></span>
						${errorajax }
							${errorinfo }${errorname }
						</div>
						<div class="input">
						...
						<a class="news-letter" href="#">
							<label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i>Sign Up for Manager</label>
						</a>
						<div class="clearfix"> </div>
					</div>
