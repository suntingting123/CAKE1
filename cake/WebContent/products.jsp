...
function loadType() {
	...
	success: function(msg) {
	    if (msg.retcode == 0) {    // 成功
	        ...
	        $('#subbtn').text('签到失败: ' + msg.retmsg);
	    }
	},
	error: function() { $('#subbtn').text('系统错误'); }
	});
	}
</script>	
</head>
<body>
			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="/cake/checkout.jsp">Cart</a></li>
						<li class="dropdown">
				...
				<div class="product-grid">
					<a href="detail.jsp">
						...
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/${p.image }" class="img-responsive" alt=""/>
							<div class="b-wrapper">
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							<h4>${p.name }</h4>								
							<span class="item_price">${p.discountprice }</span>
							<div class="ofr">
								<p class="pric1"><del>${p.price}</del></p>
								<p class="disc">${p.discount }</p>
							</div>
							<input type="text" class="item_quantity" value="1" />
							
							<a class="item_add items" href="/cake/product/addCart?id=${p.id }">add</a>
							<div class="clearfix"> </div>
						</div>						
					</div>
				</div>
			...
			<div class="col-md-3 rsidebar span_1_of_left">
				<section  class="sky-form">
					<div class="product_right">
						<h4 class="m_2"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span><a href="" onblur="loadType()">Categories</a></h4>
						<div class="tab1">
							<ul class="place">								
	...
	<div class="footer-bottom">
		<div class="container">
			<p>Copyright &copy; 2015.Company name All rights reserved.More Templates <a href="" target="_blank" title="小米">小米</a> - Collect from <a href="" title="小米" target="_blank">小米</a></p>
		</div>
	</div>
</body>
</html>