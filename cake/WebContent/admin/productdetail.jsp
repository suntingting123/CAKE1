...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     ...
     <section>
      <ul class="ulColumn2">
      <form action="${ctx }/product/addBack" method="post" enctype="multipart/form-data">
       <li>
      ...
      <li>
        ...
        <input type="text" class="textbox" name="price" placeholder="价格..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">折扣价：</span>
        <input type="text" class="textbox" name="discountprice" placeholder="折扣价..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">折扣：</span>
        <input type="text" class="textbox" name="discount" placeholder="折扣..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
       ...
       <li>
        <span class="item_name" style="width:120px;" name="image">上传图片：</span>
       ...
       <li>
        <span class="item_name" style="width:120px;" name="description">产品详情：</span>
