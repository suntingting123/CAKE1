 ...
 <ul>
  <li>
   <dl>
    <dt>常用布局示例</dt>
    <!--当前链接则添加class:active-->
    <dd><a href="${ctx }/product/get" class="active">商品列表</a></dd>
    <dd><a href="${ctx }/product/addBack">添加商品</a></dd>
  ...
  <li>
   <dl>
    <dt>订单信息</dt>
    <dd><a href="${ctx }/order/get">订单列表</a></dd>
  ...
  <li>
   <dl>
    <dt>会员管理</dt>
    <dd><a href="${ctx }/user/get">会员列表</a></dd>
