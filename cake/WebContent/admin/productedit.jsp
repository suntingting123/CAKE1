...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     ...
     <section>
      <ul class="ulColumn2">
      <form action="${ctx }/product/updateback?id=${product.id}" enctype="multipart/form-data" method="post">
       <li>
        <span class="item_name" style="width:120px;">商品名称：</span>
        <input type="text" name="name" value="${product.name}" class="textbox textbox_295" placeholder="商品名称..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">商品货号：</span>
        <input type="text" id="name" name="id" value="${product.id}" class="textbox" placeholder="商品货号..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
      ...
      <li>
        ...
        <input type="text" class="textbox" value="${product.price}" name="price" placeholder="价格..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">折扣价：</span>
        <input type="text" class="textbox" value="${product.discountprice}" name="discountprice" placeholder="折扣价..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">折扣：</span>
        <input type="text" class="textbox" value="${product.discount}" name="discount" placeholder="折扣..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
      ...
      <li>
        ...
        <textarea rows="10" cols="100" name="description">${product.description}</textarea>
       </li>
       <li> 
