    ...
    <div class="left_content">
            ...
            <div class="sidebarmenu">
                ...
                <div class="submenu">
                    ...
                    <li><a href="">添加商品</a></li>
                    <li><a href="">修改商品</a></li>
                    <li><a href="${ctx }/product/get">删除商品</a></li>
                    <li><a href="${ctx }/product/get">商品列表</a></li>
                    </ul>
                </div>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tbody>
    	...
    	<tr>
            ...
            <td><a href="#"><img src="${ctx }/admin/images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="${ctx }/user/delete?id=${p.id}" class="ask"><img src="${ctx }/admin/images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
        </c:forEach>
